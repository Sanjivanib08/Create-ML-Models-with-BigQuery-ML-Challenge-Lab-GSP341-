...
This guide is for ```customer_classification_model```, please read your instruction lab <strong>Task 2</strong> carefully <br/>

### Task 1. Create a new dataset
* Open BigQuery
* Create dataset and add ID from task 1 : as given  ```bq_dataset```
...
```
then 
when it completes.. check the progess bar  after 
cut the code and add below code and Run
...
```
and After it completes tick the check my progress bar Then ,
run this query
```sql
#standardSQL
SELECT
